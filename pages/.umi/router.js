...
import RendererWrapper0 from 'F:/zhangwu/laravel/antd/wjcms_antd_pro/src/pages/.umi/LocaleWrapper.jsx'
...
let routes = [
  ...
  LoadingComponent: require('F:/zhangwu/laravel/antd/wjcms_antd_pro/src/components/PageLoading/index').default,
}),
    "routes": [
      {
        "path": "/user",
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__User__models__register.js' */'F:/zhangwu/laravel/antd/wjcms_antd_pro/src/pages/User/models/register.js').then(m => { return { namespace: 'register',...m.default}})
],
...
models: () => [
  ...
  LoadingComponent: require('F:/zhangwu/laravel/antd/wjcms_antd_pro/src/components/PageLoading/index').default,
      ...
      {
        "component": () => React.createElement(require('F:/zhangwu/laravel/antd/wjcms_antd_pro/node_modules/umi-build-dev/lib/plugins/404/NotFound.js').default, { pagesPath: 'src/pages', hasRoutesInConfig: true })
      }
    ]
  },
  {
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Dashboard__models__activities.js' */'F:/zhangwu/laravel/antd/wjcms_antd_pro/src/pages/Dashboard/models/activities.js').then(m => { return { namespace: 'activities',...m.default}}),
  import(/* webpackChunkName: 'p__Dashboard__models__chart.js' */'F:/zhangwu/laravel/antd/wjcms_antd_pro/src/pages/Dashboard/models/chart.js').then(m => { return { namespace: 'chart',...m.default}}),
  import(/* webpackChunkName: 'p__Dashboard__models__monitor.js' */'F:/zhangwu/laravel/antd/wjcms_antd_pro/src/pages/Dashboard/models/monitor.js').then(m => { return { namespace: 'monitor',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Forms__models__form.js' */'F:/zhangwu/laravel/antd/wjcms_antd_pro/src/pages/Forms/models/form.js').then(m => { return { namespace: 'form',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__List__models__rule.js' */'F:/zhangwu/laravel/antd/wjcms_antd_pro/src/pages/List/models/rule.js').then(m => { return { namespace: 'rule',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Profile__models__profile.js' */'F:/zhangwu/laravel/antd/wjcms_antd_pro/src/pages/Profile/models/profile.js').then(m => { return { namespace: 'profile',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Exception__models__error.js' */'F:/zhangwu/laravel/antd/wjcms_antd_pro/src/pages/Exception/models/error.js').then(m => { return { namespace: 'error',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Account__Settings__models__geographic.js' */'F:/zhangwu/laravel/antd/wjcms_antd_pro/src/pages/Account/Settings/models/geographic.js').then(m => { return { namespace: 'geographic',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Member__models__member.js' */'F:/zhangwu/laravel/antd/wjcms_antd_pro/src/pages/Member/models/member.js').then(m => { return { namespace: 'member',...m.default}})
],
  component: () => import(/* webpackChunkName: "p__Member__MemberList" */'../Member/MemberList'),
  LoadingComponent: require('F:/zhangwu/laravel/antd/wjcms_antd_pro/src/components/PageLoading/index').default,
}),
            "exact": true
          },
